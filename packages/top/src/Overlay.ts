 ...
 * @property {number[]} [offset=[0, 0]] Offsets in pixels used when positioning
 * the overlay. The first element in the
 * array is the horizontal offset. A positive value shifts the overlay right.
 * The second element in the array is the vertical offset. A positive value
 * shifts the overlay down.
 * @property {Coordinate} [position] The overlay position
 * in map projection.
...
/**
 * @typedef {ObjectEventType|'change:element'|'change:map'|'change:offset'|'change:position'|
 ...
 *   OnSignature<OverlayObjectEventTypes, ObjectEvent, Return> &
 *   CombinedOnSignature<EventTypes|OverlayObjectEventTypes, Return>} OverlayOnSignature
 */
...
export class Overlay extends BaseObject {
    ...
    constructor(options: Options) {
        super();
        this.on = this.onInternal as OverlayOnSignature<EventsKey>;
        this.once = this.onceInternal as OverlayOnSignature<EventsKey>;
        this.un = this.unInternal as OverlayOnSignature<void>;
     ...
     */
    getOffset(): number[] {
        return /** @type {number[]} */ (this.get(Property.OFFSET));
    }

    /**
     * Get the current position of this overlay.
     * @return {Coordinate|undefined} The spatial point that the overlay is
     *     anchored at.
     * @observable
     * @api
     */
     ...
     * overlay is hidden.
     * @param {Coordinate|undefined} position The spatial point that the overlay
     *     is anchored at.
     * @observable
     * @api
     */
