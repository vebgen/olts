 ...
 * @type {number[]}
 */
const LEADING_DIGITS: number[] = [1, 2, 5];

/**
 * @const
 * @type {number}
 */
const DEFAULT_DPI: number = 25.4 / 0.28;
...
export class ScaleLine extends Control {
    ...
    constructor(options: Options) {
        ...
        this.on = this.onInternal as ScaleLineOnSignature<EventsKey>;
        this.once = this.onceInternal as ScaleLineOnSignature<EventsKey>;
        this.un = this.unInternal as ScaleLineOnSignature<void>;
