...
/**
 * @typedef {ObjectEventType|'change:layergroup'|'change:size'|'change:target'|'change:view'} MapObjectEventTypes
 */
 ...
 *    OnSignature<import("./MapBrowserEventType").Types, import("./MapBrowserEvent").default, Return> &
 *    OnSignature<import("./MapEventType").Types, import("./MapEvent").default, Return> &
 *    OnSignature<import("./render/EventType").MapRenderEventTypes, import("./render/Event").default, Return> &
 *    CombinedOnSignature<EventTypes|MapObjectEventTypes|
...
export class Map extends BaseObject {
     ...
     * @return {Size|undefined} The size in pixels of the map in the DOM.
     * @observable
     * @api
     */
     ...
     * @param {Size|undefined} size The size in pixels of the map in the DOM.
     * @observable
     * @api
     */
     ...
     * @param {Size|undefined} size The size.
     * @private
     */
 ...
 */
function createOptionsInternal(options: MapOptions): MapOptionsInternal {
    /**
     * @type {HTMLElement|Document}
     */
    let keyboardEventTarget: HTMLElement | Document = null;
    ...
    let interactions: Collection<import("./interaction/Interaction").default>;
