 ...
 * buffer.
 */
function createMinion(operation: (arg0:any[], arg1: object) => *): (arg0: MinionData) => ArrayBuffer {
 ...
 */
function createWorker(config: ProcessorOptions, onMessage: (arg0: MessageEvent) => void): Worker {
 ...
 */
function createFauxWorker(config: ProcessorOptions, onMessage: (arg0: FauxMessageEvent) => void): object {
...
export class Processor extends Disposable {
     ...
     */
    process(inputs:ImageData[], meta: object, callback: (arg0: Error, arg1: ImageData, arg2: object) => void) {
        this._enqueue({
            inputs: inputs,
            meta: meta,
            callback: callback,
 ...
 * @property {number[]|null} [resolutions] Resolutions. If specified, raster operations will only
...
export class RasterSource extends ImageSource {
    ...
    constructor(options: Options) {
        ...
        this.on = this.onInternal as RasterSourceOnSignature<EventsKey>;
        this.once = this.onceInternal as RasterSourceOnSignature<EventsKey>;
        this.un = this.unInternal as RasterSourceOnSignature<void>;
     ...
     * @api
     */
    setOperation(operation: Operation, lib: object) {
        if (this.processor_) {
