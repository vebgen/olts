...
export function createExtent(extent: Extent, onlyCenter: boolean, smooth: boolean): Type {
    return (
        /**
         * @param {Coordinate|undefined} center Center.
         * @param {number|undefined} resolution Resolution.
         * @param {Size} size Viewport size; unused if `onlyCenter` was specified.
         * @param {boolean} [isMoving] True if an interaction or animation is in progress.
         * @param {Array<number>} [centerShift] Shift between map center and viewport center.
         * @return {Coordinate|undefined} Center.
         */
        function (
            center: Coordinate | undefined,
            resolution: number | undefined,
