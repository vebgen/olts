 ...
 *   CombinedOnSignature<import("../Observable").EventTypes|import("./Base").BaseLayerObjectEventTypes|LayerEventType|
 ...
 * construction.
 * @property {import("../Map").default|null} [map] Map.
...
export class Layer extends BaseLayer {
    ...
    constructor(options: Options<SourceType>) {
        ...
        super(baseOptions);
        this.on = this.onInternal as LayerOnSignature<EventsKey>;
        this.once = this.onceInternal as LayerOnSignature<EventsKey>;
        this.un = this.unInternal as LayerOnSignature<void>;
     ...
     * @api
     */
    isVisible(view: View | import("../View").ViewStateLayerStateExtent): boolean {
        let frameState;
     ...
     */
    render(frameState: import("../Map").FrameState | null, target: HTMLElement): HTMLElement | null {
     ...
     */
    setMapInternal(map: import("../Map").default | null) {
        if (!map) {
            this.unrender();
        }
     ...
     */
    getMapInternal(): import("../Map").default | null {
 ...
 */
export function inView(layerState: State, viewState: import("../View").State): boolean {
