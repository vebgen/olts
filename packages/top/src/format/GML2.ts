...
import {writeStringTextNode} from './xsd';
...
export class GML2 extends GMLBase {
  ...
  readFlatCoordinates(node, objectStack) {
    ...
    const context = /** @type {import("../xml").NodeStackItem} */ (
      objectStack[0]
    );
  ...
  /**
   * @param {Node} node Node.
   * @param {Geometry|Extent} geometry Geometry.
   * @param {Array<*>} objectStack Node stack.
   */
  ...
  /**
   * @param {Node} node Node.
   * @param {LineString|LinearRing} value Geometry.
   * @param {Array<*>} objectStack Node stack.
   * @private
   */
  ...
  /**
   * @param {Element} node Node.
   * @param {LinearRing} ring LinearRing geometry.
   * @param {Array<*>} objectStack Node stack.
   */
  ...
  /**
   * @param {Element} node Node.
   * @param {Point} geometry Point geometry.
   * @param {Array<*>} objectStack Node stack.
   */
  ...
  /**
   * @param {Element} node Node.
   * @param {MultiPoint} geometry MultiPoint geometry.
   * @param {Array<*>} objectStack Node stack.
   */
  ...
  /**
   * @param {Element} node Node.
   * @param {LinearRing} geometry LinearRing geometry.
   * @param {Array<*>} objectStack Node stack.
   */
