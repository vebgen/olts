...
import { boundingExtent, getArea } from '@olts/core/extent';
import {
    closestOnSegment,
 ...
 * @property {Extent} [extent] Initial extent. Defaults to no
 * initial extent.
...
export class ExtentEvent extends Event {
    /**
     * @param {Extent} extent the new extent
     */
...
export class Extent extends PointerInteraction {
    ...
    constructor(options: Options) {
        ...
        this.on = this.onInternal as ExtentOnSignature<EventsKey>;
        this.once = this.onceInternal as ExtentOnSignature<EventsKey>;
        this.un = this.unInternal as ExtentOnSignature<void>;
         ...
         * @type {function (Coordinate): Extent|null}
         * @private
         */
    ...
    /**
     * @param {import("../pixel").Pixel} pixel cursor location
     * @param {import("../Map").default} map map
     * @return {Coordinate|null} snapped vertex on extent
     * @private
     */
    snapToVertex_(pixel: import("../pixel").Pixel, map: import("../Map").default): Coordinate | null {
     ...
     * @private
     */
    createOrUpdateExtentFeature_(extent: Extent): Feature {
    ...
    /**
     * @param {Coordinate} vertex location of feature
     * @return {Feature} vertex as feature
     * @private
     */
    createOrUpdatePointerFeature_(vertex: Coordinate): Feature {
     ...
     *
     * @return {Extent} Drawn extent in the view projection.
     * @api
     */
    getExtent(): Extent {
        return toUserExtent(
 ...
 *
 * @return {import("../style/Style").StyleFunction} Default Extent style
 */
function getDefaultExtentStyleFunction(): import("../style/Style").StyleFunction {
 ...
 *
 * @return {import("../style/Style").StyleFunction} Default pointer style
 */
function getDefaultPointerStyleFunction(): import("../style/Style").StyleFunction {
    const style = createEditingStyle();
    return function (feature, resolution) {
        return style['Point'];
    };
...
/**
 * @param {Coordinate} fixedPoint corner that will be unchanged in the new extent
 * @return {function (Coordinate): Extent} event handler
 */
function getPointHandler(fixedPoint: Coordinate): (arg0: Coordinate) => Extent {
...
/**
 * @param {Coordinate} fixedP1 first corner that will be unchanged in the new extent
 * @param {Coordinate} fixedP2 second corner that will be unchanged in the new extent
 * @return {function (Coordinate): Extent|null} event handler
 */
function getEdgeHandler(fixedP1: Coordinate, fixedP2: Coordinate): (arg0: Coordinate) => Extent | null {
