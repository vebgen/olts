...
export class Triangulation {
  ...
  constructor(
    ...
    /**
     * @param {Coordinate} c A coordinate.
   ...
   * @param {Coordinate} a The target a coordinate.
   * @param {Coordinate} b The target b coordinate.
   * @param {Coordinate} c The target c coordinate.
   * @param {Coordinate} aSrc The source a coordinate.
   ...
   * @param {Coordinate} b The target b coordinate.
   * @param {Coordinate} c The target c coordinate.
   * @param {Coordinate} d The target d coordinate.
   * @param {Coordinate} aSrc The source a coordinate.
   * @param {Coordinate} bSrc The source b coordinate.
   * @param {Coordinate} cSrc The source c coordinate.
   ...
   *
   * @return {Extent} Calculated extent.
   */
