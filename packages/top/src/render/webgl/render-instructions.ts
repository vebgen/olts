...
function pushCustomAttributesInRenderInstructions(
  ...
  customAttributes: import('./VectorStyleRenderer').AttributeDefinitions,
  batchEntry: import("./MixedGeometryBatch").GeometryBatchItem,
  currentIndex: number,
): number {
  let shift = 0;
 ...
 * @param {import("./MixedGeometryBatch").PointGeometryBatch} batch Point geometry batch
 * @param {Float32Array} renderInstructions Render instructions
 * @param {import('./VectorStyleRenderer').AttributeDefinitions} customAttributes Custom attributes
...
export function generatePointRenderInstructions(
  batch: import("./MixedGeometryBatch").PointGeometryBatch,
  renderInstructions: Float32Array,
  customAttributes: import('./VectorStyleRenderer').AttributeDefinitions,
 ...
 * @param {import("./MixedGeometryBatch").LineStringGeometryBatch} batch Line String geometry batch
 * @param {Float32Array} renderInstructions Render instructions
 * @param {import('./VectorStyleRenderer').AttributeDefinitions} customAttributes Custom attributes
 * @param {import("../../transform").Transform} transform Transform to apply to coordinates
 * @return {Float32Array} Generated render instructions
...
export function generateLineStringRenderInstructions(
  batch: import("./MixedGeometryBatch").LineStringGeometryBatch,
  renderInstructions: Float32Array,
  customAttributes: import('./VectorStyleRenderer').AttributeDefinitions,
  transform: import("../../transform").Transform,
): Float32Array {
 ...
 * @param {import("./MixedGeometryBatch").PolygonGeometryBatch} batch Polygon geometry batch
 * @param {Float32Array} renderInstructions Render instructions
 * @param {import('./VectorStyleRenderer').AttributeDefinitions} customAttributes Custom attributes
 * @param {import("../../transform").Transform} transform Transform to apply to coordinates
 * @return {Float32Array} Generated render instructions
...
export function generatePolygonRenderInstructions(
  batch: import("./MixedGeometryBatch").PolygonGeometryBatch,
  renderInstructions: Float32Array,
  customAttributes: import('./VectorStyleRenderer').AttributeDefinitions,
  transform: import("../../transform").Transform,
): Float32Array {
