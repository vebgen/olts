...
/**
 * @typedef {{0: CanvasRenderingContext2D, 1: number, 2: import("../canvas").Label|HTMLImageElement|HTMLCanvasElement|HTMLVideoElement, 3: ImageOrLabelDimensions, 4: number, 5: Array<*>, 6: Array<*>}} ReplayImageOrLabelArgs
 */
