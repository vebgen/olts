...
export class CanvasImmediateRenderer extends VectorContext {
  ...
  constructor(
    ...
    userTransform: import("../../proj").TransformFunction,
  ) {
    super();
   ...
   * @param {import("../../transform").Transform} transform Transform.
   */
  setTransform(transform: import("../../transform").Transform) {
    this.transform_ = transform;
  }
   ...
   * @api
   */
  drawFeature(feature: default, style: import("../../style/Style").default) {
   ...
   * the current style.
   *
   * @param {Point|import("../Feature").default} geometry Point geometry.
   */
  drawPoint(geometry: Point | import("../Feature").default) {
    if (this.squaredTolerance_) {
      geometry = /** @type {Point} */ (
        geometry.simplifyTransformed(
          this.squaredTolerance_,
   ...
   * @private
   */
  setContextFillState_(fillState: import("../canvas").FillState) {
    const context = this.context_;
   ...
   * @private
   */
  setContextStrokeState_(strokeState: import("../canvas").StrokeState) {
    const context = this.context_;
   ...
   * @private
   */
  setContextTextState_(textState: import("../canvas").TextState) {
    const context = this.context_;
   ...
   */
  setImageStyle(imageStyle: import("../../style/Image").default) {
    let imageSize;
   ...
   */
  setTextStyle(textStyle: import("../../style/Text").default) {
    if (!textStyle) {
      this.text_ = '';
    } else {
