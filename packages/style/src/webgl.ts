...
/**
 * @typedef {import("../expr/expression").ExpressionValue} ExpressionValue
 */
/**
 * @typedef {import("../color").Color|string|Array<ExpressionValue>} ColorExpression
 */
 ...
 * @property {import("./Icon").IconOrigin} [fill-pattern-offset-origin='top-left'] Origin of the offset: `bottom-left`, `bottom-right`,
 * `top-left` or `top-right`.
 * @property {ExpressionValue|import("../size").Size} [fill-pattern-size] Fill pattern image size in pixel. Can be used together with `fill-pattern-offset` to define the
 ...
 * sub-rectangle to use from the original fill pattern image.
 * @property {import("./Icon").IconOrigin} [stroke-pattern-offset-origin='top-left'] Origin of the offset: `bottom-left`, `bottom-right`,
 * `top-left` or `top-right`.
 * @property {ExpressionValue|import("../size").Size} [stroke-pattern-size] Stroke pattern image size in pixel. Can be used together with `stroke-pattern-offset` to define the
 * sub-rectangle to use from the origin (sprite) fill pattern image.
 ...
 * @property {import("./Icon").IconOrigin} [icon-anchor-origin='top-left'] Origin of the anchor: `bottom-left`, `bottom-right`,
 * `top-left` or `top-right`.
 * @property {import("./Icon").IconAnchorUnits} [icon-anchor-x-units='fraction'] Units in which the anchor x value is
 * specified. A value of `'fraction'` indicates the x value is a fraction of the icon. A value of `'pixels'` indicates
 * the x value in pixels.
 * @property {import("./Icon").IconAnchorUnits} [icon-anchor-y-units='fraction'] Units in which the anchor y value is
 ...
 * @property {ExpressionValue|number|import("../size").Size} [icon-scale=1] Scale.
 ...
 * @property {import("./Icon").IconOrigin} [icon-offset-origin='top-left'] Origin of the offset: `bottom-left`, `bottom-right`,
 * `top-left` or `top-right`.
 * @property {ExpressionValue|import("../size").Size} [icon-size] Icon size in pixel. Can be used together with `icon-offset` to define the
 ...
 * @property {ExpressionValue|Array<ExpressionValue>|number|import("../size").Size} [shape-scale=1] Scale. Unless two dimensional scaling is required a better
 ...
 * @property {ExpressionValue|Array<ExpressionValue>|number|import("../size").Size} [circle-scale=1] Scale. A two dimensional scale will produce an ellipse.
