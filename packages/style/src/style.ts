 ...
 * @property {string|import("../geom/Geometry").default|GeometryFunction} [geometry] Feature property or geometry
 * or function returning a geometry to render for this style.
 * @property {import("./Fill").default} [fill] Fill style.
 * @property {import("./Image").default} [image] Image style.
 * @property {RenderFunction} [renderer] Custom renderer. When configured, `fill`, `stroke` and `image` will be
 * ignored, and the provided function will be called with each render frame for each geometry.
 * @property {RenderFunction} [hitDetectionRenderer] Custom renderer for hit detection. If provided will be used
 * in hit detection rendering.
 * @property {import("./Stroke").default} [stroke] Stroke style.
 * @property {import("./Text").default} [text] Text style.
...
class Style {
  ...
  constructor(options) {
    ...
    /**
     * @private
     * @type {string|import("../geom/Geometry").default|GeometryFunction|null}
     */
    this.geometry_ = null;
    ...
    /**
     * @private
     * @type {import("./Fill").default|null}
     */
    this.fill_ = options.fill !== undefined ? options.fill : null;

    /**
     * @private
     * @type {import("./Image").default|null}
     */
    ...
    /**
     * @private
     * @type {import("./Stroke").default|null}
     */
    this.stroke_ = options.stroke !== undefined ? options.stroke : null;

    /**
     * @private
     * @type {import("./Text").default|null}
     */
   ...
   * @return {string|import("../geom/Geometry").default|GeometryFunction|null}
  ...
  /**
   * Get the fill style.
   * @return {import("./Fill").default|null} Fill style.
   * @api
   */
  getFill() {
    return this.fill_;
  ...
  /**
   * Set the fill style.
   * @param {import("./Fill").default|null} fill Fill style.
   * @api
   */
  setFill(fill) {
    this.fill_ = fill;
  ...
  /**
   * Get the image style.
   * @return {import("./Image").default|null} Image style.
   * @api
   */
  getImage() {
    return this.image_;
   ...
   * @return {import("./Stroke").default|null} Stroke style.
   * @api
   */
  getStroke() {
    return this.stroke_;
   ...
   * @param {import("./Stroke").default|null} stroke Stroke style.
   * @api
   */
  setStroke(stroke) {
    this.stroke_ = stroke;
  ...
  /**
   * Get the text style.
   * @return {import("./Text").default|null} Text style.
   * @api
   */
  getText() {
    return this.text_;
  ...
  setGeometry(geometry) {
    if (typeof geometry === 'function') {
      ...
      this.geometryFunction_ = function () {
        return /** @type {import("../geom/Geometry").default} */ (geometry);
      };
    }
...
export function createEditingStyle() {
  /** @type {Object<import("../geom/Geometry").Type, Array<Style>>} */
  const styles = {};
  const white = [255, 255, 255, 1];
  const blue = [0, 153, 255, 1];
  const width = 3;
